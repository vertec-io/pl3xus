...
use fanuc_replica_plugins::{ConnectionState, ActiveConfigState, GetRobotConfigurations, LoadConfiguration};
        ...
        <Show when=move || robot_connected.get()>
            <div class="bg-background rounded border border-border/8 p-3 shrink-0">
                ...
                <Show when=move || show_save_modal.get()>
                    ...
                    >
                        <div class="bg-background border border-border/15 rounded-lg p-6 max-w-md"
