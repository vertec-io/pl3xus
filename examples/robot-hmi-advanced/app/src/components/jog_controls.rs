...
use robot_hmi_plugins::fanuc::types::{JogSettingsState, JogCommand, JogAxis, JogDirection};
    ...
    view! {
        <button
            class=move || if disabled.get() {
                "bg-card border border-border/8 text-muted-foreground font-semibold py-1.5 rounded text-center text-[10px] cursor-not-allowed opacity-50"
            } else {
