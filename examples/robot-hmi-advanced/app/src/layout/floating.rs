    ...
    view! {
        <Show when=move || layout_ctx.jog_popped.get()>
            <div
                ...
                class="fixed bg-card rounded border border-[#00d9ff40] shadow-2xl z-50 select-none flex flex-col"
                style=move || format!(
            ...
            >
                ...
                <div
                    node_ref=header_el
                    class="flex items-center justify-between p-2 cursor-move border-b border-border/10 shrink-0"
                >
                    ...
                    <button
                        class="p-0.5 hover:bg-border/10 rounded cursor-pointer"
...
pub fn FloatingIOStatus() -> impl IntoView {
    ...
    view! {
        <Show when=move || layout_ctx.io_popped.get()>
            <div
                node_ref=container_el
                class="fixed bg-card rounded border border-[#00d9ff40] shadow-2xl z-50 w-72 select-none flex flex-col"
                style=move || format!(
                    "touch-action: none; {}",
                    style.get()
                )
