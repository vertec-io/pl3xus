...
use robot_hmi_plugins::fanuc::types::{ConnectionState, ListRobotConnections, ConnectToRobot, DisconnectRobot};
...
pub fn ProgramNotificationHandler() -> impl IntoView {
    use robot_hmi_plugins::programs::types::{ProgramNotification, ProgramNotificationKind};
...
pub fn ConsoleLogHandler() -> impl IntoView {
    use robot_hmi_plugins::core::types::{ConsoleLogEntry, ConsoleDirection, ConsoleMsgType};
