...
use robot_hmi_plugins::fanuc::types::{ActiveConfigState, RobotPosition, JointAngles};
...
pub fn CommandComposerModal() -> impl IntoView {
    ...
    view! {
        <div class="fixed inset-0 bg-black/70 flex items-center justify-center z-50">
            <div class="bg-background border border-border/15 rounded-lg w-[600px] max-h-[90vh] flex flex-col">
                // Header
                ...
                <div class="flex-1 overflow-y-auto p-4 space-y-4">
                    ...
                    <div class="space-y-2">
                        ...
                        <select
                            class="w-full bg-card border border-[#00d9ff40] rounded px-3 py-2 text-[12px] text-foreground focus:border-primary focus:outline-none"
                            on:change=move |ev| {
                ...
                <div class="flex justify-between p-3 border-t border-border/8">
                    <button
                        class="bg-popover border border-border/15 text-foreground text-[10px] px-4 py-1.5 rounded hover:bg-secondary"
                    ...
                    <div class="flex gap-2">
                        <button
                            class="bg-[#00d9ff20] border border-[#00d9ff40] text-primary text-[10px] px-4 py-1.5 rounded hover:bg-primary/20"
                            on:click=move |_| apply_command.get_value()()
                        >
                            "Apply"
                        </button>
                        <button
                            class="bg-success text-primary-foreground text-[10px] px-4 py-1.5 rounded hover:bg-success font-medium"
