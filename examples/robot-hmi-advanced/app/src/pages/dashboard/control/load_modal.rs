...
use robot_hmi_plugins::programs::types::{ListPrograms, Load};
    ...
    F: Fn() + Clone + 'static,
{
    ...
    view! {
        <div class="fixed inset-0 bg-black/70 flex items-center justify-center z-50">
            <div class="bg-background border border-border/15 rounded-lg w-[500px] max-h-[80vh] flex flex-col">
                // Header
                                ...
                                view! {
                                    <button
                                        class=move || format!(
                                            ...
                                            if is_selected() {
                                                "bg-[#00d9ff20] border-primary text-foreground"
                                            } else {
                                                "bg-card border-border/8 text-foreground hover:bg-popover hover:border-border/15"
                                            }
                                        )
