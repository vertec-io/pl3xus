...
use robot_hmi_plugins::fanuc::types::{ConnectionState, JogSettingsState};
            ...
            <div class="bg-background rounded border border-border/8 p-3 shrink-0">
                ...
                <Show when=move || has_changes.get()>
                    <div class="flex justify-end mt-2 gap-2">
                        ...
                        <button
                            class="px-3 py-1 text-[9px] bg-[#ffaa0020] text-warning border border-warning rounded hover:bg-warning/20"
                            on:click=move |_| {
