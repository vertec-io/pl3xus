...
use robot_hmi_plugins::fanuc::types::{ConnectionState, GetFrameData, GetToolData, GetActiveFrameTool};
            ...
            <Show when=move || !robot_connected.get() fallback=move || {
                ...
                <div class="h-full flex items-center justify-center">
                    <div class="bg-background rounded border border-border/8 p-8 max-w-md text-center">
                        ...
                        <h2 class="text-lg font-semibold text-foreground mb-2">"No Robot Connected"</h2>
