...
use robot_hmi_plugins::programs::types::{ProgramDetail, UpdateProgramSettings, SequenceType, Instruction};
...
pub fn ProgramDetails(
    ...
    #[prop(into)] _selected_program_id: Signal<Option<i64>>,
...
#[component]
fn InstructionsTable(instructions: Vec<Instruction>) -> impl IntoView {
