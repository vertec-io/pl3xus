...
use robot_hmi_plugins::programs::types::{
...
fn SequenceItemView(
    ...
    let on_delete_stored = StoredValue::new(on_delete);
    let on_csv_upload_stored = StoredValue::new(on_csv_upload);
    let default_point_stored = StoredValue::new(default_point);
