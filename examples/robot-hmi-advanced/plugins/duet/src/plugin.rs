...
use crate::systems::{duet_command_handler_system, duet_http_sender_system};
use crate::types::DuetCommandEvent;
...
impl Plugin for DuetPlugin {
    fn build(&self, app: &mut App) {
        ...
        app.add_systems(
            Update,
            duet_http_sender_system.after(duet_command_handler_system),
        );
