...
//!
//! NOTE: This file is feature-gated behind `server` in lib.rs,
...
use crate::systems::{
    ...
    RobotPollingPlugin, FanucValidationPlugin, handle_jog_settings_mutation,
};
...
use robot_hmi_core::database::DatabaseInitRegistry;
