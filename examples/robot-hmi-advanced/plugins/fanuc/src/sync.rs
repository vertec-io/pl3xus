...
impl Plugin for RobotSyncPlugin {
    fn build(&self, app: &mut App) {
        ...
        app.add_systems(Update, (
            ...
            handlers::handle_set_active_frame_tool,
        ));

        // Frame/Tool and I/O write handlers (require authorization)
        app.add_systems(Update, (
            handlers::handle_write_frame_data,
            handlers::handle_write_tool_data,
            handlers::handle_write_dout,
            handlers::handle_write_aout,
            handlers::handle_write_gout,
        ));

        // Frame/Tool and I/O read handlers (no authorization)
        app.add_systems(Update, (
            handlers::handle_get_active_frame_tool,
            handlers::handle_get_frame_data,
            handlers::handle_get_tool_data,
            handlers::handle_read_din,
            handlers::handle_read_din_batch,
            handlers::handle_read_ain,
            handlers::handle_read_gin,
