...
## Position Flow in Robot HMI Advanced
...
Robot HMI Advanced stores rotation as quaternion but doesn't convert it when sending to FANUC. This works only because:
...
- robot-hmi: Hardcoded in `instruction_to_packet()`
- Robot HMI Advanced: Loaded from .env once at startup
