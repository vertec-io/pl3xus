...
### How It Works
- `RobotPosition(dto::Position)` with x,y,z,w,p,r in robot-hmi
- `Isometry3<f32>` in Robot HMI Advanced toolpaths (but broken conversion)
...
### Phase 1: Fix Robot HMI Advanced's convert_to_position()
