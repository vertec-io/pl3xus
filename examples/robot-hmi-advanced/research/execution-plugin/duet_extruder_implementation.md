...
## 1. Robot HMI Advanced Analysis

### How Robot HMI Advanced Does It
...
| Robot HMI Advanced | Our Architecture |
|-----------|------------------|
...
### Part of Application (Robot HMI Advanced-specific or example)
...
| Refill logic | Robot HMI Advanced-specific |
| Microwave control | Robot HMI Advanced-specific |
