...
This document captures important patterns and anti-patterns discovered while developing the robot-hmi example application using the pl3xus framework.
...
1. **Define Types** (`robot_hmi_types/src/lib.rs`)
