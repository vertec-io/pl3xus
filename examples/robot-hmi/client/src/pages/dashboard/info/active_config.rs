...
use robot_hmi_types::{ConnectionState, ActiveConfigState, GetRobotConfigurations, LoadConfiguration};
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <Show when=move || { config.get().changes_count > 0 }>
                                <button
                                    class="px-2 py-1 text-[9px] bg-warning/20 text-warning border border-warning rounded hover:bg-warning/30"
                                    on:click=move |_| {
                            ...
                            <Show when=move || { config.get().changes_count > 0 }>
                                <button
                                    class="px-2 py-1 text-[9px] bg-success/20 text-success border border-success rounded hover:bg-success/30"
