...
use robot_hmi_types::{ProgramDetail, UpdateProgramSettings};
                            ...
                            <div class="p-3 border-b border-border/8">
                                <div class="flex items-start justify-between">
                                    ...
                                    <div class="flex gap-1">
                                        <button
                                            class="bg-primary/20 border border-primary/40 text-primary text-[9px] px-2 py-1 rounded hover:bg-primary/30"
                                            on:click=move |_| set_show_csv_upload.set(true)
                                        >
                                            "⬆ Upload CSV"
                                        </button>
                                        <button
                                            class="bg-destructive/20 border border-destructive/40 text-destructive text-[9px] px-2 py-1 rounded hover:bg-destructive/30"
                                            on:click={
                            ...
                            <div class="px-3 pb-3 border-b border-border/8 flex items-end gap-3 flex-wrap">
                                <div>
                                    <div class="flex items-center gap-2 mb-1">
                                        ...
                                        <div class="text-[7px] text-muted">"(mm/s)"</div>
                                    </div>
                                    <input
                                        type="text"
                                ...
                                <div>
                                    <div class="flex items-center gap-2 mb-1">
                                        ...
                                        <div class="text-[7px] text-muted">"(0-100)"</div>
                                    </div>
                                    <input
                                        type="text"
                                ...
                                <Show when=move || settings_modified.get()>
                                    <button
                                        class="bg-success/20 border border-success/40 text-success text-[9px] px-3 py-1 rounded hover:bg-success/30"
                                        on:click=move |_| {
    ...
    view! {
        <div class="px-3 pb-2">
            <div class="flex items-center gap-2 mb-1">
                ...
                <div class="text-[7px] text-muted">{hint}</div>
            </div>
...
#[component]
fn InstructionsTable(instructions: Vec<robot_hmi_types::Instruction>) -> impl IntoView {
        ...
        <div class="h-full flex items-center justify-center">
            <div class="text-center">
                ...
                <div class="flex gap-2 justify-center">
                    <button
                        class="bg-primary/20 border border-primary/40 text-primary text-[9px] px-3 py-1.5 rounded hover:bg-primary/30"
                        on:click=move |_| set_show_open_modal.set(true)
                    >
                        "Open Program"
                    </button>
                    <button
                        class="bg-success/20 border border-success/40 text-success text-[9px] px-3 py-1.5 rounded hover:bg-success/30"
