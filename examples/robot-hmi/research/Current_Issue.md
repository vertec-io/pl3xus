...
- `examples/robot-hmi/client/src/layout/top_bar.rs` - ControlResponseHandler uses StoredValue
- `examples/robot-hmi/client/src/components/toast.rs` - ToastContext uses StoredValue
