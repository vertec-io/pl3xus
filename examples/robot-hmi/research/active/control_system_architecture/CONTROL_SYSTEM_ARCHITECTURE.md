...
This document analyzes the challenges encountered while implementing exclusive control in the robot-hmi application, evaluates different architectural patterns, and proposes future directions for the pl3xus framework.
...
```rust
// In shared types crate (robot_hmi_types)
