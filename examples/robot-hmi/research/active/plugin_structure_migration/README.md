...
**Created**: 2025-12-24
**Goal**: Migrate robot-hmi from shared-types structure to plugin-based structure

---

## Objective

Create a copy of robot-hmi and convert it to use the plugin-based project structure (as documented in `pl3xus-project-structure` skill). This is a structural refactoring only - no functionality changes.
...
```
robot-hmi_plugins/   # Or new directory name
├── Cargo.toml               # Workspace
├── plugins/
...
### Phase 1: Setup
- [ ] Create new directory `robot-hmi_plugins/`
