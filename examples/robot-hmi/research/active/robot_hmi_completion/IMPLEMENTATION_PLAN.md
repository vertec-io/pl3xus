...
**File**: `examples/robot-hmi/client/src/pages/dashboard/control/program_display.rs`

```bash
# Find the line
grep -n "system_entity_bits" examples/robot-hmi/client/src/pages/dashboard/control/program_display.rs
```
...
**Files**: 
- `examples/robot-hmi/server/src/plugins/execution.rs`
...
```bash
cargo check --package robot_hmi_server --package robot_hmi_client 2>&1 | grep -E "warning:|error:"
```
...
**Files to Modify**:
- `examples/shared/robot_hmi_types/src/lib.rs` - Add `TargetedRequestMessage` impl
- `examples/robot-hmi/server/src/plugins/requests.rs` - Register as targeted
- `examples/robot-hmi/client/src/pages/dashboard/control/quick_commands.rs` - Use `use_mutation_targeted`
...
**File**: `examples/shared/robot_hmi_types/src/lib.rs`
...
**Files**:
- `examples/robot-hmi/client/src/pages/programs/mod.rs`
- `examples/robot-hmi/client/src/app.rs` (router)
...
**Files**:
- `examples/shared/robot_hmi_types/src/lib.rs` - Add to `IoConfigState`
- `examples/robot-hmi/client/src/components/io_status.rs` - Display custom names
- `examples/robot-hmi/server/src/plugins/io.rs` - Store/load names
...
```bash
# Build check
cargo check --package robot_hmi_server --package robot_hmi_client

# Run and test
cd examples/robot-hmi/server && cargo run &
