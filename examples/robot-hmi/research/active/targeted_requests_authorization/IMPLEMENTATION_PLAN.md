...
### Step 4.1: Add to robot-hmi example
...
| File | Change | Lines |
|------|--------|-------|
| `robot-hmi/server/src/main.rs` | Modify | +15 |
| `robot-hmi/shared/src/messages.rs` | Modify | +25 |
| `robot-hmi/client/src/components/` | Modify | +40 |
...
### Example Validation
1. robot-hmi jog commands work with control
