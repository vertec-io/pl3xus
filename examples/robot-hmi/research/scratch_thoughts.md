...
-- PROMPT --
Read examples/robot-hmi/research/active/coordinate-abstraction/start_here.md to understand the coordinate abstraction research. The preliminary research is complete - your task is to validate the findings and begin implementing Phase 1.
